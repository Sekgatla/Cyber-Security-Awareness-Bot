using System;
  ...
  namespace CybersecurityChatbot
  {
      ...
      // Transforms a raw keyword response by prepending sentiment opener
      // and personalised greeting before it is displayed in the GUI.
      // This satisfies the "Use delegates" assignment requirement.
          ...
          public string ProcessInput(string input)
          {
                  ...
                  || lower.Contains("go on")      || lower.Contains("keep going"))
              {
                  if (!string.IsNullOrEmpty(_lastTopic))
                  {
                      ...
                      if (followUp != null)
                      {
                          // Use ResponseTransformer delegate to apply personalised opener
              ...
              // ── Step 5: Match a keyword and use ResponseTransformer delegate ──
              ...
              if (keywordResponse != null)
              {
                  ...
                  // Use the ResponseTransformer delegate to prepend sentiment and
                  // personalised greeting before the cybersecurity tip
              ...
              if (lower.Contains("what can you") || lower.Contains("what do you")
                  ...
                  || lower.Contains("help"))
              {
                  return "Here are all the cybersecurity topics I can help with:\n\n"
                       + "  • Passwords          • Phishing\n"
                       + "  • Scams              • Privacy\n"
                       + "  • Malware            • 2FA\n"
                       + "  • Public Wi-Fi       • Social Engineering\n\n"
