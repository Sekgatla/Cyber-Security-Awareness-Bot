...
| 9 Topics | DANGER / WARNING / SAFE / INFO colour severity |
...
| Session Stats | Message count and duration on exit |
...
|---------|-------|----------------|
| GUI Design | 10 | Dark WPF layout — navy/cyan/white theme, ASCII art header |
...
| Memory and Recall | 10 | MemoryStore stores name + favourite topic; personalises replies |
| Sentiment Detection | 10 | 5-state enum; auto-prepends empathetic opener before tip |
| Code Optimisation | 10 | 4 classes; no God class; delegate for response formatting |
...
## Cybersecurity Topics Covered (Both Parts)
